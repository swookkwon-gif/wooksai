...
9. **[최소 분량] 반드시 1,500단어(한글 3,000자) 이상 작성할 것.** 절대 짧게 쓰지 마.
10. 각 소제목(##) 아래에 최소 3개의 문단(각 문단 3문장 이상)을 작성해.
11. 구체적인 수치, 실제 사례, 비유를 반드시 포함하여 독자의 이해를 도울 것.
12. 단순한 사실 나열이 아닌 '왜 중요한가'에 대한 분석적 관점을 반드시 포함할 것.
"""
...
8. **[최소 분량] 반드시 1,500단어(한글 3,000자) 이상 작성할 것.** Top 3 각각을 최소 400단어 이상 심층 분석해.
9. 포스트 하단에 '## 📚 참고자료' 섹션을 추가할 것.
"""
...
8. **[최소 분량] 반드시 1,500단어(한글 3,000자) 이상 작성할 것.**
9. 각 소제목(##) 아래에 최소 3개의 문단(각 문단 3문장 이상)을 작성해.
10. 역사적 배경, 현대 적용 사례, 구체적 수치를 풍부하게 포함할 것.
"""
