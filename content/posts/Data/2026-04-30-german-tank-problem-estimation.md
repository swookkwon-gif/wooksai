...
**[다음 편 예고]**
"평균, 분산, 상관계수가 모두 완벽하게 똑같은 4개의 데이터 세트가 있습니다. 이 4개는 똑같은 데이터일까요?"
숫자만 보고 "그렇다"고 대답했다면, 당신은 데이터의 함정에 빠진 것입니다. 그래프로 그리는 순간 눈을 의심하게 만드는 충격적인 시각화의 마법, **'앤스컴의 콰르텟(Anscombe's Quartet)'**에 대해 알아보겠습니다.
